"use client";
import "./chunk-VNAGWAIF.js";
import {
  Combination_default,
  hideOthers
} from "./chunk-HACRW6YJ.js";
import {
  require_react_dom
...
function useComposedRefs3(...refs) {
  return React30.useCallback(composeRefs5(...refs), refs);
}
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React32.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime18.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React32.isValidElement(newElement) ? React32.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React32.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
function useCallbackRef2(callback) {
  const callbackRef = React34.useRef(callback);
  React34.useEffect(() => {
    callbackRef.current = callback;
  });
  return React34.useMemo(() => (...args) => {
    var _a;
    return (_a = callbackRef.current) == null ? void 0 : _a.call(callbackRef, ...args);
  }, []);
}
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React35.useLayoutEffect : () => {
};
...
var PopperAnchor = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime20.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React39.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime21.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var Presence = (props) => {
  ...
  const ref = useComposedRefs2(presence.ref, getElementRef6(child));
...
function useComposedRefs4(...refs) {
  return React41.useCallback(composeRefs6(...refs), refs);
}
...
function createContextScope5(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      return (0, import_jsx_runtime22.jsx)(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
    function useContext22(consumerName, scope) {
      var _a;
...
var useLayoutEffect25 = (globalThis == null ? void 0 : globalThis.document) ? React43.useLayoutEffect : () => {
};
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React45.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime23.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React45.isValidElement(newElement) ? React45.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useInsertionEffect2 = React48[" useInsertionEffect ".trim().toString()] || useLayoutEffect25;
function useControllableState2({
  ...
  const value = isControlled ? prop : uncontrolledProp;
  if (true) {
    const isControlledRef = React48.useRef(prop !== void 0);
    React48.useEffect(() => {
      const wasControlled = isControlledRef.current;
      if (wasControlled !== isControlled) {
        const from = wasControlled ? "controlled" : "uncontrolled";
...
function useUncontrolledState2({
  ...
  const [value, setValue] = React48.useState(defaultProp);
  const prevValueRef = React48.useRef(value);
  const onChangeRef = React48.useRef(onChange);
  useInsertionEffect2(() => {
    onChangeRef.current = onChange;
  }, [onChange]);
  React48.useEffect(() => {
...
var RovingFocusGroup = React49.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime25.jsx)(Collection.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime25.jsx)(Collection.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime25.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime26.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime26.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var Slot7 = createSlot3("MenuContent.ScrollLock");
...
var MenuGroup = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var useReactId3 = React51[" useId ".trim().toString()] || (() => void 0);
var count4 = 0;
function useId3(deterministicId) {
  const [id, setId] = React51.useState(useReactId3());
  useLayoutEffect2(() => {
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime27.jsx)(Portal2, { ...menuScope, ...portalProps });
};
